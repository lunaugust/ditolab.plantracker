...
const styles: Record<string, import("react").CSSProperties> = {
  ...
  heroMetric: {
    ...
    padding: "8px 10px",
    borderRadius: 999,
    background: `linear-gradient(180deg, ${colors.textPrimary}10 0%, ${colors.accent.orange}16 100%)`,
  ...
  sourceBadge: {
    ...
    borderRadius: 999,
    padding: "6px 10px",
    background: `linear-gradient(180deg, ${colors.textPrimary}0d 0%, ${colors.surfaceElevated}ec 100%)`,
  },
  progressDots: {
    display: "flex",
    gap: 6,
  ...
  editActionBtn: {
    ...
    alignItems: "center",
    gap: 4,
    background: `linear-gradient(180deg, ${colors.textPrimary}08 0%, ${colors.surfaceAlt}e4 100%)`,
    border: `1px solid ${colors.textPrimary}10`,
    borderRadius: 999,
    padding: "8px 12px",
    color: colors.textSecondary,
