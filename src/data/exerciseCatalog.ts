...
export const EXERCISE_CATALOG: ExerciseCatalogEntry[] = [
  ...
  { slug: "dumbbell-step-up", exerciseDbId: "dumbbell-step-up", name: { es: "Step-ups con mancuernas", en: "Dumbbell Step-up" }, synonyms: ["step ups", "dumbbell step ups"] },
  ...
  { slug: "rear-delt-raise", exerciseDbId: "rear-delt-raise", name: { es: "Elevaciones Posteriores", en: "Rear Delt Raise" }, synonyms: ["elevaciones posteriores con mancuernas", "rear delt flyes"] },
  { slug: "lateral-raise", exerciseDbId: "lateral-raise", name: { es: "Vuelos Laterales", en: "Lateral Raise" }, synonyms: ["vuelos laterales con mancuernas", "lateral raises"] },
  { slug: "front-raise", exerciseDbId: "front-raise", name: { es: "Elevaciones Frontales", en: "Front Raise" }, synonyms: ["front raises"] },
  ...
  { slug: "rope-pushdown", exerciseDbId: "rope-pushdown", name: { es: "Pushdown en Polea", en: "Cable Rope Pushdown" }, synonyms: ["triceps en polea con cuerda", "tríceps en polea con cuerda", "cable pushdown"] },
  ...
  { slug: "decline-bench-press", exerciseDbId: "decline-bench-press", name: { es: "Press Declinado", en: "Decline Bench Press" }, synonyms: ["decline press"] },
  ...
  { slug: "cable-fly", exerciseDbId: "cable-fly", name: { es: "Aperturas en Polea", en: "Cable Fly" }, synonyms: ["cable flyes"] },
